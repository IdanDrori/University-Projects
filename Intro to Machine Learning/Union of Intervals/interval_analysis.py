...
if __name__ == '__main__':
    analysis = Analysis()
    #analysis.experiment_m_range_erm(10, 100, 5, 3, 100)
    #analysis.experiment_k_range_erm(1500, 1, 10, 1)
    analysis.experiment_k_range_srm(1500, 1, 10, 1)
    analysis.cross_validation(1500)
